...
//let multReturn = multiply(5,9);
//console.log(multReturn);
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  let bigAdd = sum(a,b)[0];
  let biggerAdd = sum(bigAdd,c)[0];
  let bigMultiply = multiply(a,b)[0];
  let biggerMultiply = multiply(bigMultiply,c)[0];
  let messageOne = `${a} and ${b} and ${c} sum to ${biggerAdd}.`;
